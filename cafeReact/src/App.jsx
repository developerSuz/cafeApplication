...
function App(props) {
  ...
  const tasksNoun = taskList.length !== 1 ? "items for sale today" : "item for sale today";
  ...
  return (
    ...
    {isLoading ? (
      ...
      <main className="todoapp stack-large">
        <div className="cafeNameDiv box">
          <h1 className="cafeName">Academy Cafe</h1>        
          <img src="public/images/logoTransp512.png" alt="Cafe Logo" className="cafeLogoMain"/>
        </div>       
        <div>
          {nearestCafe && (
            <div
              style={{
                ...
                alignItems: "center",
                backgroundColor:
                  nearestCafe === "Alva" ? "#e6f7ff" : nearestCafe === "London" ? "#f0f9eb" : "",
                fontSize: nearestCafe === "London" ? "30px" : "30px",
                padding: "20px 0px 20px 0px",
                borderRadius: "10px",
              }}
            >
              <span>{nearestCafe}</span>
              {showWrongCafeButton && taskCount <= 1 && (
                <button
                  onClick={handleWrongCafe}
                  style={{
                    marginTop: "10px",
                    fontSize: "0.6em",
                    border: "none",
